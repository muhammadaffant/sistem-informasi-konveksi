    ...
    <nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            ...
            <li class="nav-item {{ Request::is('contact') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('user.kontak') }}">Contact</a>
            </li>
            ...
            @auth
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item" href="{{ route('user.profile') }}">History pembelian</a>
                    <a class="dropdown-item" href="{{ route('user.profile') }}">History pemesanan</a>

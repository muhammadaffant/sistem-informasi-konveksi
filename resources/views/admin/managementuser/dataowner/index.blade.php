                        ...
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addAdminModal">
                                    <i class="fas fa-user-tie"></i> Tambah Owner
                                </button>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-striped" id="table-1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $owner->email }}</td>
                                            {{-- <td>{{ $owner->phone }}</td> --}}
                                            <td>{{ $owner->roles->pluck('name')->first() ?? 'No Role' }}</td>
                                            <td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addAdminModalLabel">Tambah Owner</h5>
            ...
            <form action="{{ route('admin.store') }}" method="POST">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary">Tambah Owner</button>
                </div>
            </form>
        </div>
    </div>

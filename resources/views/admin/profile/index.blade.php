          ...
          <div class="col-12 col-md-12 col-lg-5">
            ...
            <div class="card profile-widget">
              ...
              <div class="profile-widget-description">
                <div class="profile-widget-name">{{ auth()->user()->username }}<div class="text-muted d-inline font-weight-normal"><div class="slash"></div> {{ auth()->user()->fullname }}</div></div>
              </div>
                ...
                <div class="card-body">
                    <div class="row">                               
                      <div class="form-group col-md-6 col-12">
                        ...
                        <input type="text" class="form-control @error('fullname') is-invalid @enderror" id="fullname" name="fullname" value="{{ auth()->user()->fullname }}">
                        @error('fullname') 

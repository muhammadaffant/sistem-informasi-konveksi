...
@section('container')
            ...
            <div class="section-body">
                <div class="row">
                    <div class="col-12">
                        <x-card>
                            <x-slot name="header">
                                <button onclick="addForm(`{{ route('jasalayanan.store') }}`)"
    ...
    @include('admin.data-layanan.form')
@endsection
...
@push('scripts')
    <script>
        ...
        function addForm(url, title = 'Tambah Data Layanan') {
            $(modal).modal('show');
        ...
        // fungsi edit data
        function editForm(url, title = 'Edit Data Layanan') {
